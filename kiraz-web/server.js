...
const spindItems = [
    ...
    { name: 'Pistolen Munition', value: 'Pistolen Munition' },
    { name: 'SMG Munition', value: 'SMG Munition' },
    { name: 'Shotgun Munition', value: 'Shotgun Munition' },
    { name: 'Leichte Weste', value: 'Leichte Weste' },
    { name: 'Schwere Weste', value: 'Schwere Weste' },
    { name: 'Kokain', value: 'Kokain' },
    { name: 'Handschellen', value: 'Handschellen' },
    { name: 'Schalldämpfer', value: 'Schalldämpfer' },
    { name: 'Erweitertes Magazin', value: 'Erweitertes Magazin' },
    { name: 'Visier', value: 'Visier' },
    { name: 'Griff', value: 'Griff' },
    { name: 'Frosch', value: 'Frosch' },
    { name: 'Ephi Extrakt', value: 'Ephi Extrakt' },
    { name: 'Ephi', value: 'Ephi  ' },
    { name: 'Zündladung', value: 'Zündladung ' },
    { name: 'Projektil', value: 'Projektil ' },
    { name: 'Partonenhülsen', value: 'Partonenhülsen  ' },
    { name: 'Lithiumfolie', value: 'Lithiumfolie ' },
    { name: 'Natronlauge', value: 'Natronlauge ' },
    { name: 'Ammoniumnitrat', value: 'Ammoniumnitrat' },
    { name: 'Schlagbolzen', value: 'Schlagbolzen' },
    { name: 'Riegel', value: 'Riegel' },
    { name: 'Waffenrahmen', value: 'Waffenrahmen' },
    { name: 'Schwarzgeld', value: 'Schwarzgeld' },
    { name: 'GPS', value: 'GPS' },
    { name: 'Bandagen', value: 'Bandagen' },
    { name: 'Klammerpflaster', value: 'Klammerpflaster' },
    { name: 'Verbandskasten', value: 'Verbandskasten' },
    { name: 'Repkit', value: 'Repkit ' }
];
